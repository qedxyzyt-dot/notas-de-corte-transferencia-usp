...
def escrever_readme(out_dir: Path, site_url: str | None) -> None:
    linhas = [
        ...
        "- Agrupamento por nome-base do curso com comparação por campus quando a FUVEST distingue localizações",
        "- Avisos quando parte dos indicadores permanece no escopo da carreira ampla oficial",
        ...
        "## Fonte dos dados",
        "",
        "Os dados exibidos neste site foram extraídos dos relatórios oficiais da própria FUVEST. Nos anos recentes, a diferenciação entre carreiras repetidas por código e entre cursos localizados dentro de carreiras amplas também foi conferida com os guias e listagens oficiais da FUVEST. Em caso de divergência, o PDF oficial do respectivo ano deve ser considerado a referência final.",
        "",
